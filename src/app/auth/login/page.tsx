    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans antialiased flex flex-col items-center justify-center relative overflow-hidden px-4">
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-zinc-500">Access your production environment</p>
        </div>
        ...
        <div className="bg-zinc-900/40 border border-zinc-800/80 backdrop-blur-xl p-8 rounded-2xl shadow-2xl shadow-black/50">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center gap-2.5 pt-1">
              ...
              />
              <label htmlFor="remember" className="text-xs font-medium text-zinc-400 select-none cursor-pointer hover:text-zinc-300 transition-colors">
        ...
        <p className="text-center text-xs text-zinc-500 font-medium">
          New to the network?{' '}
          <Link href="/auth/signup" className="text-zinc-300 hover:text-blue-400 hover:underline transition-colors ml-0.5">
            Create an account
          </Link>
        </p>
      </motion.div>
